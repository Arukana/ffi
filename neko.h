  ...
  { None_Emotion = 95,
    ...
    Shocked = 111,
    Sleepy = 115,
    Speechless = 101, } t_emotion;

  /// Neko Placement Selection
  typedef struct s_position
  { t_cardinal cardinal;
    unsigned short cartesian[2]; } t_position;

  /// Neko's Texels Definition
  typedef struct s_tuple
  { t_part part;
    t_emotion emotion; } t_tuple;
  ...
  { /// Style Attributes
    ...
    unsigned int glyph; } t_character;
  ...
  { t_sheet sheet;
    ...
    unsigned char unmount; } t_lbstat;
#endif
